...
RSpec.describe Sidekiq::CloudWatchMetrics do
  ...
  describe "Publisher" do
    ...
    describe "#publish" do
      ...
      it "publishes to custom namespace" do
        Timecop.freeze(now = Time.now) do
          stats = instance_double(Sidekiq::Stats,
            processed: 123,
            failed: 456,
          ...
          publisher_with_custom_namespace =
            Sidekiq::CloudWatchMetrics::Publisher.new(client: client, namespace: 'MyNamespace')
          publisher_with_custom_namespace.publish
